...
export declare class PetContract extends Contract {
    ...
    createPet(ctx: Context, chipID: string, name: string, species: string, breed: string, owner: string, ownerID: string, phone: string, birthday: string, gender: string, bloodType: string, ligation: boolean, allergy: string, majorDiseases: string, remark: string, hospital: string, imgID: string): Promise<void>;
